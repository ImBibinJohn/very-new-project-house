...
class Addnewproject(models.Model):
    ...
    uploadthumbnail = models.ImageField(
    ...
    uploadscreenshots = models.ImageField(
        upload_to='images/', null=True, verbose_name='')
    uploadscreenshots1 = models.ImageField(
        upload_to='images/', null=True, verbose_name='')
    uploadscreenshots2 = models.ImageField(
        upload_to='images/', null=True, verbose_name='')
    uploadscreenshots3 = models.ImageField(
        upload_to='images/', null=True, verbose_name='')
    uploadpdf = models.FileField(
        upload_to='images/', null=True, verbose_name='', default='')
...
class GetProject(models.Model):
    project_Detail = models.ForeignKey(
        Addnewproject, on_delete=models.CASCADE, default=None)
    name = models.CharField(max_length=100)
    phone = models.CharField(max_length=100)
    email = models.CharField(max_length=100)
